...
/*!************************************!*\
  !*** ./src/graphicsConstructor.js ***!
  \************************************/
/*! exports provided: scene, camera, renderer, controls, ambient, velocity, direction, w, s, a, d, up, down, xP, xN, yP, yN, zP, zN, axisX, axisZ */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/physics/createObjects/createCameraObj.js":
/*!******************************************************!*\
  !*** ./src/physics/createObjects/createCameraObj.js ***!
  \******************************************************/
/*! exports provided: cameraShape, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"cameraShape\", function() { return cameraShape; });\n/* harmony import */ var _createRigidObjects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../createRigidObjects */ \"./src/physics/createRigidObjects.js\");\n/* harmony import */ var _graphicsConstructor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../graphicsConstructor */ \"./src/graphicsConstructor.js\");\n/* harmony import */ var _initiatePhysics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../initiatePhysics */ \"./src/physics/initiatePhysics.js\");\n\n\n\n\nvar cameraShape;\n\nfunction createCameraObj() {\n    cameraShape = new Ammo.btSphereShape(5);\n    var transform = new Ammo.btTransform();\n    transform.setIdentity();\n    var position = new THREE.Vector3(_graphicsConstructor__WEBPACK_IMPORTED_MODULE_1__[\"camera\"].position.x, _graphicsConstructor__WEBPACK_IMPORTED_MODULE_1__[\"camera\"].position.y, _graphicsConstructor__WEBPACK_IMPORTED_MODULE_1__[\"camera\"].postion.z);\n    transform.setOrigin(new Ammo.btVector3(position.x, position.y, position.z));\n    transform.setRotation(new Ammo.btQuaternion(0, 0, 0, 1));\n    var motionState = new Ammo.btDefaultMotionState(transform);\n    var inertia = new Ammo.btVector3(0, 0, 0);\n    cameraShape.calculateLocalInertia(0, inertia);\n    var rigidBodyInfo = new Ammo.btRigidBodyConstructionInfo(0, motionState, cameraShape, inertia);\n    var rigidBody = new Ammo.btRigidBody(rigidBodyInfo);\n    _initiatePhysics__WEBPACK_IMPORTED_MODULE_2__[\"physicsWorld\"].addRigidBody(rigidBody); \n}\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (createCameraObj);\n\n//# sourceURL=webpack:///./src/physics/createObjects/createCameraObj.js?");
